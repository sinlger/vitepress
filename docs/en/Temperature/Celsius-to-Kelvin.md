...
head:
  - - meta
    - name: description
      content: "在线摄氏�?°C)到开尔文(K)转换工具。轻松进行温度单位换算，提供详细的换算公式、示例和常见问题解答，帮助您快速完成摄氏度与开尔文的转换�?
  - - meta
    - name: keywords
      content: "摄氏度转开尔文, 摄氏度与开尔文的换�? 温度转换, 温度换算, 摄氏度与开尔文换算, 摄氏度的符号, k和摄氏度换算, 开尔文和摄氏度的换�?

---
# 摄氏�?(°C) �?开尔文 (K) 的换�?

需要快速将**摄氏�?(°C)** 转换�?*开尔文 (K)** 吗？这个页面提供了简单易用的在线**温度转换**工具，以及详细的**摄氏度与开尔文的换�?*公式和示例，让您轻松掌握**摄氏度与开尔文换算**�?
...
�?*摄氏�?(°C)** 换算�?*开尔文 (K)** 的公式非常简单：
$$ K = °C + 273.15 $$
这个公式是所�?*开尔文和摄氏度的换�?*的基础�?
