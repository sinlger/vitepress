...
head:
  ...
  - - meta
    - name: description
      content: 汤匙(Tbs)与立方米(m³)单位换算工具�?汤匙等于0.00001478676立方米�?
  - - meta
    - name: keywords
      content: 汤匙,立方�?单位换算,Tbs,m3
---
...
## 换算公式
1 汤匙(Tbs) = 0.00001478676 立方�?m³)

### 换算原理
汤匙(Tbs)和立方米(m³)都是体积单位�?汤匙等于�?.0000148立方米�?

## 常见换算�?
| 汤匙(Tbs) | 立方�?m³)    | 实物参�?                |
|-----------|--------------|--------------------------|
| 1         | 0.00001478676| 标准汤匙容量              |
| 0.5       | 0.00000739338| 半汤匙容�?               |
| 0.25      | 0.00000369669| 四分之一汤匙容量          |
| 2         | 0.00002957352| 两汤匙容�?               |
| 3         | 0.00004436028| 三汤匙容�?               |
