...
head:
  ...
  - - meta
    - name: description
      content: 立方毫米(mm³)与千�?kl)单位换算工具�?立方毫米等于0.000000001千升�?
  - - meta
    - name: keywords
...
### 换算原理
立方毫米(mm³)和千�?kl)都是体积单位�?千升等于1000升。换算基于长度单位关系：
- 1 厘米(cm) = 10 毫米(mm)
...
| 500000000    | 0.5     | 中型鱼缸的水�?           |
| 100000000    | 0.1     | 大型浴缸的水�?           |
