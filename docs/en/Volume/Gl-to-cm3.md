...
head:
  ...
  - - meta
    - name: description
      content: 吉升(Gl)与立方厘�?cm³)单位换算工具�?吉升等于1,000,000,000,000立方厘米�?
  - - meta
    - name: keywords
...
### 换算原理
吉升(Gl)和立方厘�?cm³)都是体积单位�?吉升等于1万亿立方厘米�?
...
## 单位换算技�?
1. **快速心算法**�?
   - 吉升转立方厘�?�?数值乘�?,000,000,000,000
   - 立方厘米转吉�?�?数值除�?,000,000,000,000
