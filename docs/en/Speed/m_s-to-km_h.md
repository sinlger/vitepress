...
head:
  ...
  - - meta
    - name: keywords
      content: 速度单位换算, 米每秒转�? m/s to km/h, 一米每秒等于多少千米每小时, km/h和m/s换算, 米每秒换算千米每小时, 速度转换, 速度单位, 米每秒和千米每小时的换算, km/h换算m/s, 千米每小时换算米每秒, m/s km/h, 米每�? 速度的单�?
---
...
const seoKey = ['速度单位换算','米每秒转�?,'km/h m/s 変換','m/s to mm/s','m/s to kmh','ft/min to m/s','ft/s to m/s','m/s to km/h','速度的单�?,'m/s km/h','米每�?,'一千米每小时等于多少米每秒','m/s和km/h','km/h和m/s换算','米每秒换算千米每小时','一米每秒等于多少千米每小时','速度转换','速度单位','米每秒和千米每小时的换算','m s','km/h换算m/s','千米每小时换算米每秒']
...
- 1�?= 0.001千米
- 1�?= 1/3600小时
- 因此�? m/s = (1�?1�? × (0.001千米/1�? × (3600�?1小时) = 3.6 km/h
...
- 飞机起飞速度�?0 m/s �?288 km/h

**体育运动�?*
- 百米冲刺世界纪录�?0 m/s �?36 km/h
- 马拉松配�?分钟/公里 �?4.17 m/s �?15 km/h

**气象预报�?*
- 风速常用m/s表示，但新闻播报用km/h
- 台风风�?0 m/s = 180 km/h�?7级超强台风）
