...
breadcrumb:
  ...
  - - link: /Mass/st-to-t
      linkText: Stone to Ton
head:
  - - meta
    - name: description
      content: "Mass unit conversion guide covering detailed conversion formulas and explanations from stone (st) to ton (t)."
  - - meta
    - name: keywords
      content: "mass, unit conversion, stone, ton, st, t, stone to ton, mass conversion guide"
---
# Stone (st) to Ton (t) Conversion
---
<script setup>
...
const convertHandler = () => {
  if (form.number !== null && !isNaN(form.number)) {
    ...
    form.result = `${form.number}st = ${convertedValue.toFixed(8)}t`
  } else {
...
**1 stone (st) = 0.00635029318 tons (t)**

The conversion formula is:
```
Tons = Stones × 0.00635029318
```

## Conversion Guide

### Why Convert Stones to Tons?
...
3. **Construction Projects**: Converting weight specifications for large-scale projects
4. **Agricultural Applications**: Converting livestock weight to bulk measurements

### Conversion Method

To convert stones to tons:
...
- **10 st** = 0.06350293 t
- **100 st** = 0.63502932 t
- **157 st** = 0.99699643 t (approximately 1 ton)
- **1000 st** = 6.35029318 t

## Summary

Converting stones to tons involves multiplying by 0.00635029318. This conversion is essential for industrial applications, shipping and logistics, construction projects, and agricultural applications where traditional weight measurements need to be expressed in larger units.
