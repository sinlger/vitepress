...
head:
  - - meta
    - name: description
      content: "年到周换算器 - 精确的年(year)到周(week)时间单位转换工具。支持工作计划、项目管理、学期安排等应用场景。使用公�?year × 52.1775 进行换算，提供详细的计算步骤和实际应用案例�?
  - - meta
    - name: keywords
      content: "年到周换算器, 时间单位换算, 年转�? year to week, 工作计划, 项目管理, 学期安排, 时间规划, 年周转换, 时间计算�?
---
# �?(year) �?�?(week) 的换�?
...
const form = reactive({
  ...
  result: '',
  title: '年到周换算器',
  seoKey: ['年到�?, '工作计划', '项目管理', '学期安排', '时间规划', '年周转换', '时间计算�?, 'year to week']
})

const convertHandler = () => {
  if (form.number !== null && !isNaN(form.number)) {
    const convertedValue = parseFloat(form.number) * 52
    form.result = `${form.number}�?= ${convertedValue.toFixed(0)}周`
  } else {
...
**Q: 为什�?年不�?2周而是52.14周？**
A: 因为1�?= 365.25天（考虑闰年），�?�?= 7天，所�?�?= 365.25 ÷ 7 = 52.1428571429周�?
