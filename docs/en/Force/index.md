...
head:
  - - meta
    - name: description
      content: "力学单位换算指南，涵盖牛�?(N)、千牛顿 (kN)、磅�?(lbf)、千克力 (kgf) 的详细换算公式与说明�?
  - - meta
    - name: keywords
      content: "力学, 单位换算, 牛顿, 千牛�? 磅力, 千克�? 换算公式, 力学单位换算指南"
---
...
const options =  [
  { "label": "牛顿 (N)", "value": "N" },
  { "label": "千牛�?(kN)", "value": "kN" },
  { "label": "磅力 (lbf)", "value": "lbf" },
  { "label": "千克�?(kgf)", "value": "kgf" }
];
...
**注：**
- 换算基于国际标准重力加速度�?.80665 m/s²�?
- lbf（磅力）是英制单位，kgf（千克力）属工程单位�?
...
**千牛顿（kN�?*
- 关系�? kN = 1000 N，常用于工程结构（桥梁承重、建筑荷载）

**磅力（lbf�?*
- 背景：英制单位，1 lbf 定义�?磅质量（0.4536kg）在重力下的�?
- 场景：欧美机械规格（如扭矩扳手标定）

**千克力（kgf�?*
- 历史：旧称“公斤力”，1kgf = 1kg物体在地球重力下的受力（�?.8N�?
- 现状：逐步被牛顿取代，但仍在某些领域使用（如材料硬度测试）

### 二、单位换算的工程意义

- 安全设计：起重机吊重需将kgf换算为kN以确保结构安�?
- 设备兼容：进口设备标注lbf时需换算为N校准仪器

### 三、常见误区澄�?

- **错误认知**：�? kgf = 1 kg”（混淆质量与力�?
- **正解**：kgf是力单位，kg是质量单位，二者通过重力加速度关联�? kgf = 9.80665 N
