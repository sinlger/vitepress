...
head:
  - - meta
    - name: description
      content: "英尺到海里换算器 - 专业的长度单位转换工具。支持英�?ft)到海�?nMi)的精确换算，提供详细的换算公式和实际应用案例。适用于英制单位转换、海洋导航等场景�?
  - - meta
    - name: keywords
...
英尺到海里换算是英制长度单位与海洋导航单位之间的重要转换。英�?foot)是英制基本长度单位，海里(nautical mile)是国际海洋和航空导航的标准距离单位。本工具提供精确的英尺到海里换算功能�?
...
### 海洋与航�?
- **船舶制�?*：船体长度、甲板尺寸用英尺，航行距离用海里
- **港口工程**：码头设施尺寸用英尺，航道距离用海里
- **海洋测量**：设备尺寸用英尺，测量范围用海里

### 航空�?
- **飞机制�?*：机身尺寸、跑道长度用英尺，航行距离用海里
...
### 3. 英尺到海里的换算公式是什么？
英尺到海里的换算公式为：海里 = 英尺 ÷ 6076.12，或者海�?= 英尺 × 0.00016458。反之，英尺 = 海里 × 6076.12�?
...
### 6. 如何快速估算英尺到海里的换算？
可以记住1海里�?000英尺作为快速估算。精确值是6076.12英尺，但6000这个近似值在日常估算中很实用�?

## 公式

�?**英尺 (ft)** 换算�?**海里 (nMi)** 的公式为�?
