...
head:
  ...
  - - meta
    - name: keywords
      content: 单位转换�?单位换算,长度单位转换�?一海里等于多少公里,海里和公里怎么换算,海里,航海单位,长度单位转换,尺寸换算,英里和公里换�?
---
# 长度单位换算
...
### 海里到米转换
- **海里转米**�? nMi = 1,852 m
- **米转海里**�? m = 0.00053996 nMi
- **一海里等于多少�?*�? nMi = 1,852 m

### 海里和公里换�?
- **海里转公�?*�? nMi = 1.852 km
- **公里转海�?*�? km = 0.539957 nMi
- **一海里等于多少公里**�? nMi = 1.852 km

### 英里和海里换�?
- **英里转海�?*�? mi = 0.868976 nMi
- **海里转英�?*�? nMi = 1.15078 mi
...
### 海里和英里有什么区别？
海里(nautical mile)和英�?mile)是不同的长度单位�?
- 1海里 = 1.852公里 = 1.15078英里
- 1英里 = 1.609公里 = 0.869海里
- 海里主要用于航海和航空，英里主要用于陆地测量

### 为什么航海要用海里？
海里是基于地球的几何特性定义的�?海里等于地球子午线上1分弧长，这使得在航海导航中计算更加方便和精确�?
...
### 英里和公里换算关系是什么？
英里和公里的换算关系�?英里 = 1.609344公里�?公里 = 0.621371英里。这与海里的换算是不同的�
