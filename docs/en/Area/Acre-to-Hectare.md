...
head:
  - - meta
    - name: description
      content: "面积单位换算指南，涵盖英�?(ac) 到公�?(ha) 的详细换算公式与说明�?
  - - meta
    - name: keywords
      content: "面积, 单位换算, 英亩, 公顷, ac, ha, 英亩到公�? 面积换算指南, 英亩 平方�? 英亩和平方米的换�? 一英亩等于多少平方�? 一英亩等于多少�? 英亩和亩的换�? acres, 亩和平方米的换算, 面积换算, 一公顷等于多少平方�? acre, 单位换算"
---
# 英亩 (ac) �?公顷 (ha) 的换�?
---
<script setup>
...
const seoKey = ['英亩 平方�?,'英亩和平方米的换�?,'一英亩等于多少平方�?,'一英亩等于多少�?,'英亩和亩的换�?,'acres','亩和平方米的换算','面积换算','一公顷等于多少平方�?,'acre','单位换算']
const convert = inject('convert')

const form = reactive({
  number: null,
  result: '',
  title:'英亩 (ac) 到公�?(ha) 的换�?,
})
...
在土地测量和农业规划中，面积单位的换算是一个常见需求。本文专注于英亩 (ac) 到公�?(ha) 的换算，提供了详细的公式与实用示例�?
