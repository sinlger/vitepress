...
head:
  - - meta
    - name: description
      content: "面积单位换算指南，涵盖平方英�?(mi²) 到平方千�?(km²) 的详细换算公式与说明�?
  - - meta
    - name: keywords
      content: "面积, 单位换算, 平方英里, 平方千米, mi², km², 平方英里到平方千�? 面积换算指南, 平方英里换算平方千米, 平方英里到平方千�? 平方千米换算, 平方英里转平方千�? 平方千米计算, 大面积换�? 地理面积测量, 平方英里符号, 平方千米符号, 面积单位对照, 平方英里换算�? 平方千米换算公式, 面积转换工具, 平方英里计算, 平方千米计算�? 面积换算公式, 地理测量单位, 土地规划面积, 大规模土地换�? 平方英里到平方千米公�? 平方千米面积计算, 面积单位转换, 地图测量单位, 国际面积标准, 平方英里平方千米对照�? 面积计算工具, 国际地理单位"
---
# 平方英里 (mi²) �?平方千米 (km²) 的换�?
---
<script setup>
...
�?**平方英里 (mi²)** 换算�?**平方千米 (km²)** 的公式为�?
$$ km² = mi² \times 2.589988110336 $$

## 平方英里到平方千米换算指�?

在地理测量和大面积土地规划中，面积单位的换算是一个常见需求。本文专注于平方英里 (mi²) 到平方千�?(km²) 的换算，提供了详细的公式与实用示例�?
