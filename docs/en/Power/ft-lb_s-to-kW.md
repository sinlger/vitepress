...
head:
  - - meta
    - name: description
      content: "专业的英尺磅每秒(ft-lb/s)转千�?kW)换算工具，提供精确的功率单位转换公式、详细应用场景和实用计算器。适用于工业设备、电机功率、机械工程等国际标准功率单位换算需求�?
  - - meta
    - name: keywords
      content: "英尺磅每秒转千瓦,ft-lb/s到kW换算,功率单位换算,千瓦换算�?工业设备功率,电机功率换算,机械工程功率,国际标准功率,工程功率计算,设备功率转换"
---
# 英尺・磅每秒 (ft-lb/s) 到千�?(kW) 换算

**英尺磅每秒转千瓦换算工具**是专为国际工程标准设计的专业功率单位转换器。英尺磅每秒(ft-lb/s)是英制功率单位，而千�?kW)是国际标准的功率单位，广泛应用于工业设备、电机系统、机械工程等领域。本工具提供精确的换算公式和实时计算功能，帮助工程师、技术人员和设备专业人士进行准确的功率单位转换，特别适用于国际项目和跨标准设备选型�?
...
const seoKey = [
  '英尺磅每秒转千瓦', 'ft-lb/s到kW', '功率单位换算', '千瓦换算�?,
  '工业设备功率', '电机功率换算', '机械工程功率', '国际标准功率',
  '工程功率计算', '设备功率转换', 'フィート・ポンド毎秒からキロワッ�?,
  'パワー単位変�?, 'キロワット計算機', '産業設備出力'
]
const form = reactive({
  number:null,
  to:'',
...
<n-card title="英尺磅每秒转千瓦换算�? embedded :bordered="false" hoverable>
...
### 基础换算关系
- **1 千瓦 (kW) = 737.562 英尺磅每�?(ft-lb/s)**
- **1 英尺磅每�?(ft-lb/s) = 0.001356 千瓦 (kW)**
...
- **大型压缩�?*: 50 kW = 36,878 ft-lb/s
- **重型机械设备**: 100 kW = 73,756 ft-lb/s
- **工业生产�?*: 200 kW = 147,512 ft-lb/s

### 工程应用场景
- **工业设备能耗统�?*：将多个kW级电机功率转换为ft-lb/s单位，便于与机械负载进行匹配分析
- **国际设备选型**：将北美标准ft-lb/s换算为国际通用kW单位，便于设备采购和技术对�?
- **电机功率匹配**：在设计传动系统时，需要将电机的kW功率与机械负载的ft-lb/s需求进行匹�?
- **能效分析**：工厂设备功率消耗统计和节能改造中的单位换�?
