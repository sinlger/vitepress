...
breadcrumb:
  ...
  - - link: /zh/Length/
      linkText: 长度转换
  - - link: /zh/Length/Inch-to-Nautical-mile
      linkText: 英寸到海里
head:
  - - meta
    - name: description
      content: "英寸 (in) 到海里 (nMi) 的长度单位换算指南。了解如何通过公式 nMi = in × 0.000013715 转换为海里。"
  - - meta
    - name: keywords
      content: "长度, 单位转换, 英寸, 海里, in, nMi, 英寸到海里, 长度转换指南"
---
# 英寸 (in) 到 海里 (nMi) 的换算
---
<script setup>
