...
breadcrumb:
  ...
  - - link: /zh/Length/
      linkText: 长度转换
  - - link: /zh/Length/Micrometer-to-Foot-us
      linkText: 微米到英尺-us
head:
  - - meta
    - name: description
      content: "微米 (μm) 到美制英尺 (ft-us) 的长度单位换算指南。了解如何通过公式 ft-us = μm × 0.0000032808 转换为美制英尺。"
  - - meta
    - name: keywords
      content: "长度, 单位转换, 微米, 美制英尺, μm, ft-us, 微米到美制英尺, 长度转换指南"
---
