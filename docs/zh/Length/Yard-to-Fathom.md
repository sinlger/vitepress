...
breadcrumb:
  ...
  - - link: /zh/Length/
      linkText: 长度转换
  - - link: /zh/Length/Yard-to-Fathom
      linkText: 码到英寻
head:
  - - meta
    - name: description
      content: "码 (yd) 到英寻 (fathom) 的长度单位换算指南。了解如何通过公式 fathom = yd × 0.5 转换为英寻。"
  - - meta
    - name: keywords
      content: "长度, 单位转换, 码, 英寻, yd, fathom, 码到英寻, 长度转换指南"
---
